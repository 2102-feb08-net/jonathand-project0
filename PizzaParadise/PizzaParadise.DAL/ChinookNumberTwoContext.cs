...
{
    public partial class ChinookNumberTwoContext : DbContext
    {
        public ChinookNumberTwoContext()
        {
        }

        public ChinookNumberTwoContext(DbContextOptions<ChinookNumberTwoContext> options)
            : base(options)
        {
        }
